...
class newAdd(forms.Form):
    title = forms.CharField(label="", widget=forms.TextInput(attrs={
            'placeholder': 'new title ♡', 'id': 'new-entry-title','style': 'width:20%'}))
    data = forms.CharField(label="", widget=forms.Textarea(attrs={'placeholder': 'text', 
        'id': 'new-entry','style': 'width:46%'}))
